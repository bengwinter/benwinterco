...
var personalSite = {
  ...
  animateContactEvent: function() {
    $('#contact').click(function(e) {
      ...
      var html = "<ul id='contact-list'><li><a class='contact-list-link' href='https://github.com/bengwinter'>Github</a></li><li><a class='contact-list-link' href='http://www.linkedin.com/in/bengwinter'>LinkedIn</a></li><li><a class='contact-list-link' href='https://twitter.com/#!/winterbos'>Twitter</a></li><li>I can also be reached via email at ben.g.winter@gmail.com</li></ul>"
      $('#display-text').append(html);
    });
  }
};
